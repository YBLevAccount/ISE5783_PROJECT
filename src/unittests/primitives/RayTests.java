...
class RayTests {
	...
	void testFindClosestPoint() {
		...
		//TC03: the closest point to the head of the ray is the first element of the list
		...
		//TC04: the closest point to the head of the ray is the last element of the list
